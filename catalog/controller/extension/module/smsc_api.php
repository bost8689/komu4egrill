...
class ControllerExtensionModuleSMSCAPI {
    ...
    public function index($data){
        // $log = New Log('smsc_api.txt');
        

        // return;
        // var_dump($send_sms);
        //Сообщение отправлено успешно. ID: 9, всего SMS: 1, стоимость: 2.65, баланс: 96.5. array(4) { [0]=> string(1) "9" [1]=> string(1) "1" [2]=> string(4) "2.65" [3]=> string(4) "96.5" }
        $send_sms = $this->send_sms($phones=$data['phones'],$message=$data['message']);
        return $send_sms;
        //return SMSC_LOGIN;
    }
