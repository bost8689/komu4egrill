...
$_['text_shipping_method']           = '<span> Для доставки минимальный заказ от 300 руб. <br> для Бесплатной доставки сумма заказа от 1000 руб.<br></span>';
...
$_['entry_address_1']                = 'Адрес (только на доставку)';
$_['entry_address_2']                = 'Домофон и доп. информация';
...
$_['error_telephone2']                = 'Номер телефон мобильный должен быть указан в формате 8ХХХХХХХХХХ';
