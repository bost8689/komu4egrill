...
class ControllerExtensionModuleCheckstatusproduct extends Controller {
  ...
  public function index() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
      ...
      $this->model_extension_module_checkstatusproduct->SaveSettings();
    ...
    // Кнопки действий
    $data['action'] = $this->url->link('extension/module/checkstatusproduct', 'user_token=' . $this->session->data['user_token'], true);
  ...
  private function GetBreadCrumbs() {
    ...
    $data['breadcrumbs'][] = array(
      ...
      'href' => $this->url->link('extension/module/checkstatusproduct', 'user_token=' . $this->session->data['user_token'], true)
    );
    return $data;
  }
